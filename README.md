...
# client (local)
python3 -m hapticnet client --host 127.0.0.1 --port 9000 --rate 100 --samples 100

# client (cross-machine)
python3 -m hapticnet client --host <SERVER_LAN_IP> --port 9000 --rate 100 --samples 100

# client (auto-discovery)
python3 -m hapticnet client --discover --rate 100 --samples 100
```
